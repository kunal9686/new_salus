    ...
    <DashboardLayout pageTitle="Welcome Back">
      <div className="p-6 lg:p-10 space-y-8 min-h-full animate-in fade-in duration-700">
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {/* Daily Check-In */}
          <Card className="col-span-1 md:col-span-2 bg-card/40 border-white/25 backdrop-blur-sm animate-in slide-in-from-bottom-4 duration-500 delay-100 border-2">
            <CardHeader>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  {moods.map((m) => (
                    <Button
                      key={m.id}
                      variant="outline"
                      className="h-20 flex flex-col gap-2 rounded-2xl border-2 border-white/15 hover:border-primary hover:bg-primary/5 transition-all"
          ...
          {/* Quick Stats */}
          <Card className="bg-card/40 border-white/25 backdrop-blur-sm overflow-hidden group animate-in slide-in-from-bottom-4 duration-500 delay-200 border-2">
            ...
            <CardContent className="space-y-4">
              <div className="flex justify-between items-center p-3 rounded-xl bg-primary/5 border border-white/10 group-hover:border-white/20 transition-all">
              ...
              <div className="flex justify-between items-center p-3 rounded-xl bg-heliotrope/5 border border-white/10 group-hover:border-white/20 transition-all">
                <div className="flex items-center gap-3">
          ...
          {/* Mood Trend Chart */}
          <Card className="col-span-1 md:col-span-3 lg:col-span-2 bg-card/40 border-white/25 backdrop-blur-sm animate-in slide-in-from-bottom-4 duration-500 delay-300 border-2">
            <CardHeader>
            ...
            <CardContent className="h-[250px]">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={chartData}>
                  ...
                  <Tooltip 
                    contentStyle={{ backgroundColor: '#111', border: '1px solid rgba(255,255,255,0.25)', borderRadius: '12px' }}
          ...
          {/* Recent Reflections */}
          <Card className="col-span-1 md:col-span-3 lg:col-span-1 bg-card/40 border-white/25 backdrop-blur-sm animate-in slide-in-from-bottom-4 duration-500 delay-400 border-2">
            <CardHeader>
            ...
            <CardContent className="space-y-4">
              {recentEntries && recentEntries.length > 0 ? recentEntries.map((entry, idx) => (
                <div key={entry.id} className="p-3 rounded-xl bg-muted/20 border border-white/10 hover:border-white/25 hover:bg-muted/30 transition-all cursor-pointer group animate-in fade-in slide-in-from-right-4 duration-500" style={{ animationDelay: `${500 + (idx * 100)}ms` }}>
